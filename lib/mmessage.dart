...
import 'package:mini/strmessage.dart';
...
class _TabBarExampleState extends State<message_tab_all>
  ...
  Future<void> _noUnread(doctor_emails) async {
    ...
    var myurl = "https://healthtok.onrender.com/noPatientUnread3.php";
  ...
  Future<void> _userMessages() async {
    ...
    var url = "https://healthtok.onrender.com/recieved_messages.php";
    ...
    if (response.statusCode == 200) {
      ...
      for (var message in jsonResponse) {
        ...
        // print("out of $processedEmails");
      }

      var myurl = "https://healthtok.onrender.com/chatList.php";
      ...
      List<Future<void>> fetchUserDataFutures = [];
        ...
        for (var message in theResponse) {
          String messageEmail = message['email'] == email
              ? message['doctoremail']
              : message['email'];
          var picUrl = "https://healthtok.onrender.com/patientData.php";
