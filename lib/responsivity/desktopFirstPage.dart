                    ...
                    GestureDetector(
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('Check favourite store', style: TextStyle(fontWeight: FontWeight.w700, color: Colors.black87, fontSize: 15),)
                       ],
                     ),
                   ),
                 SizedBox(height: 20,),
                    GestureDetector(
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('Check Account', style: TextStyle(fontWeight: FontWeight.w700, color: Colors.black87, fontSize: 15),)
                       ],
                     ),
                   ),
                         SizedBox(height: 20,),
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('Your saved item(s)', style: TextStyle(fontWeight: FontWeight.w700, color: Colors.black87, fontSize: 15),)
                       ],
                     ),
                   ),    
     ...
     GestureDetector(
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('register your store', style: TextStyle(fontWeight: FontWeight.w700, color: Colors.black87, fontSize: 15),)
                       ],
                     ),
                   ),    
 SizedBox(height: 20,),
                    GestureDetector(
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('update yor shop', style: TextStyle(fontWeight: FontWeight.w700, color: Colors.black87, fontSize: 15),)
                       ],
                     ),
                   ),    
